  ...
  try {
    ...
    if (url.trim()) {
      ...
      try {
        ...
        console.log(
          "⚠️  Timeout ao carregar (continuando mesmo assim)...\n"
        );
      }
    } else {
      console.log("📌 Navegue manualmente para a página desejada.");
      console.log(
        "⏳ Aguardando você estar na página certa...\n"
      );
    ...
    // 6. Aguarda iframes carregarem
    console.log("🔍 Processando conteúdo dinâmico...");
