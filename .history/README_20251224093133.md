...
**Leia primeiro:** [GUIA_USO_SIMPLES.md](GUIA_USO_SIMPLES.md) ← *Instruções passo a passo práticas e diretas*
...
| Arquivo | Descrição |
|---------|-----------|
| **[GUIA_USO_SIMPLES.md](GUIA_USO_SIMPLES.md)** | ⚡ **COMECE AQUI** - Instruções rápidas e práticas com exemplos |
| **[GUIA_USO.md](GUIA_USO.md)** | 📖 Guia detalhado com configurações avançadas e troubleshooting |
| **[README.md](README.md)** | ℹ️ Este arquivo - Informações gerais do projeto |
...
> **Dica:** Faça um teste capturando 1-2 slides. Se o PDF cortar o título, ajuste os valores conforme o guia.
